export const BUILDINGS = [
...

  {
    ...
    actions:     ['study_ielts'],
    tendency:    '主要提升英语能力，但嘈杂的环境容易消耗心理健康。',
  },

  {
    ...
    actions:     ['study_class'],
    tendency:    '主要提升学力，但高压课堂会持续消耗心理健康。偶尔也能练到英语。',
  },

  {
    ...
    actions:     ['social_pb'],
    tendency:    '社交结果难以预测，心理健康随机波动。偶尔能获得有用信息。',
  },
...

  {
    ...
    actions:     ['research_ir'],
    tendency:    '积累科研经历标签，但几乎所有事件都伴随身体或心理代价。高风险高回报。',
  },
...

  {
    ...
    actions:     ['exercise'],
    tendency:    '稳定提升身体健康，几乎必然附带心理健康提升。代价是占用学习时间。',
  },

  {
    ...
    actions:     ['rest'],
    tendency:    '主要恢复心理健康，偶尔回复身体。但长期待在宿舍会让学力停滞甚至小幅下滑。',
  },
];