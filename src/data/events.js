...
export const EVENTS = {
  ...
  'death_mental_0': {
    event_id: 'death_mental_0', type: 'location', title: '心理崩溃',
    scenes: [{ text: '苏州的冬雨冷得刺骨，你坐在独墅湖边，看着水面上的倒影，突然觉得这一切都没有意义了。你的大脑像是一根绷得太紧终于断掉的琴弦，世界陷入了一片死寂。' }]
  },
  'death_mental_100': {
    event_id: 'death_mental_100', type: 'location', title: '彻底佛系',
    scenes: [{ text: '你悟了，你知道有更有意义的事在等着你去做。绩点、雅思、名校 Offer……这些不过是束缚灵魂的枷锁。你微笑着删掉了电脑里所有的申请材料，背起行囊，决定去寻找真正的自由。' }]
  },
  'death_physical_0': {
    event_id: 'death_physical_0', type: 'location', title: '身体透支',
    scenes: [{ text: '眼前的代码开始重叠，心跳快得像是在擂鼓。你试图站起来去接杯水，却发现四肢沉重如铅。在意识消失前的最后一秒，你听到了室友惊慌失措的呼喊声。' }]
  },
  'death_physical_100': {
    event_id: 'death_physical_100', type: 'location', title: '沉迷举铁',
    scenes: [{ text: '书本哪有杠铃亲切？你看着镜子里完美的肌肉线条，觉得申研这种久坐不动的活计简直是在亵渎人体这一上帝的完美造物。你决定把余生都交给健身房，去追求人类力量的极限。' }]
  },
  'death_money_0': {
    event_id: 'death_money_0', type: 'location', title: '资金断裂',
    scenes: [{ text: '银行卡的余额变成了个位数。你交不起这个月的房租，也付不起雅思的报名费。现实的引力太沉重了，飞扬的名校梦怦然坠地。' }]
  },
  'death_money_100': {
    event_id: 'death_money_100', type: 'location', title: '财富自由',
    scenes: [{ text: '你发现自己随手搞的小生意竟然月入十万。看着那点微薄的研究生起薪，你陷入了沉思：我到底为什么还要去受那份申研的苦？' }]
  },
