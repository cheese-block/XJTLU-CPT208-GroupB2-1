...
export const EVENTS = {
  ...
  // ── 2. 尽职调查 (早鸟线 Month 4 / 拖延线 Month 7) ──
        ...
        choices: [
          {
            ...
            flavor_text: '看着满屏的 UCL 录取通知书和学员们“感谢神仙老师”的聊天记录，你感到一种强烈的安全感，迅速锁定了机构。',
  ...
  'agency_consult_1': {
    ...
    scenes: [
      {
        text: '你在线上线下对比了多家机构。在沟通申请流程时，市场上的机构主要分为两派，你更倾向于哪种模式？',
        choices: [
          {
            text:       '倾向于“无忧托管”：承诺保录，但申请邮箱由机构统一管理。',
            effects:    { Agency_Score: -15 },
            next_event_id: 'agency_consult_2',
            flavor_text: '“不用自己天天盯邮箱查进度，还能保录名校。”你觉得这笔钱花得太值了，大四终于可以安心搞毕设了。',
            tip:        '信息不透明与夸大承诺：警惕任何“保证录取”的承诺！更致命的是，拒绝无法提供申请邮箱账号的中介！没有控制权，你连他们到底有没有递交申请都不知道。'
          },
          {
            text:       '倾向于“共创指导”：不承诺保录，但学生自己掌握申请邮箱密码。',
            effects:    { Agency_Score: +15 },
            next_event_id: 'agency_consult_2',
            flavor_text: '你清醒地表示不需要保录承诺，并强硬要求把“学生拥有申请邮箱绝对控制权”写进合同。',
            tip:        '保持主动权：中介只是辅助，你才是申请的主人。必须拥有所有申请材料的最终审核权和提交权。'
          }
        ]
      }
    ]
  ...
  'agency_consult_2': {
    ...
    scenes: [
      {
        text: '关于后期的文书和申请团队，你也发现了两种截然不同的运作模式：',
        choices: [
          {
            text:       '倾向于“矩阵式流水线”：外籍导师润色，员工离职系统无缝指派接手。',
            effects:    { Agency_Score: -15 },
            next_event_id: 'agency_consult_3',
            flavor_text: '你觉得这种不依赖单一员工的系统运作模式抗风险能力很强，而且他们提供的文书案例看起来也很规整。',
            tip:        '人员流动与模板化雷区：所谓“无缝接手”往往是机构频繁更换顾问的遮羞布！流水线作业极易导致文书千篇一律，缺乏个人特色。'
          },
          {
            text:       '倾向于“专属责任制”：主顾问从头跟到尾，名字直接写进合同，不套模板出稿慢。',
            effects:    { Agency_Score: +15 },
            next_event_id: 'agency_consult_3',
            flavor_text: '你敏锐地察觉到“无缝接手”背后的隐患，坚持要求见一见后期的主笔老师，并要求在合同中明确“中途更换老师需赔偿”。',
            tip:        '顾问稳定性：咨询时务必问清顾问从业年限，并确保合同中书写顾问姓名，防止签约后频繁换人导致质量断崖式下跌。'
          }
        ]
      }
    ]
  ...
  'agency_consult_3': {
    ...
    scenes: [
      {
        text: '最后是付款和退款环节，这也是各家机构博弈的深水区：',
        choices: [
          {
            text:       '倾向于“早鸟全款”：一次性付清享 9 折，若全拒得则“酌情扣除已发生费用”后退款。',
            effects:    { Agency_Score: -20, Money: -45000 },
            next_event_id: 'agency_settlement',
            flavor_text: '你觉得人家毕竟付出了劳动，扣点行政费是应该的。为了省下那 10% 的折扣钱，你痛快地刷卡付了全款。',
            tip:        '付款与退款雷区：强烈建议阶段性付款！退款条款必须明确“全拒得”的具体退款比例，警惕“酌情扣除”这种极具操作空间的霸王条款。'
          },
          {
            text:       '倾向于“阶段付款”：无折扣，按进度分三期付款，明确写明“全拒得 100% 退款”。',
            effects:    { Agency_Score: +15, Money: -15000 },
            next_event_id: 'agency_settlement',
            flavor_text: '你拒绝了全款打折的诱惑，要求按“30%-40%-30%”阶段付款，并逼着顾问把“酌情”改成了明确的退款数字。',
            tip:        '合同细节：阶段性付款能最大程度约束中介的后期服务质量。清晰的退款条款是你最后的底线保障。'
          }
        ]
      }
    ]
