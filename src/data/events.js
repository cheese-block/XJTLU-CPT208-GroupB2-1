...
export const EVENTS = {
  ...
  'tutorial_intro_1': {
    ...
    scenes: [
      ...
      {
        speaker: '笔记上的字',
        text:    '"抬头看看你头顶的那些‘筹码’。理智、躯壳、金钱、学识……"',
        tip:     '注意观察屏幕顶部的状态栏。',
      },
      {
        speaker: '笔记上的字',
        text:    '"任何一项枯竭，都会让你万劫不复。但别忘了，极度的膨胀同样会带来毁灭。保持平衡，在深渊上走钢丝吧。"',
        tip:     '心理、身体、资金 任何一项归零或达到 100 满值，都会直接触发游戏结束（Bad End）！',
      },
      {
        speaker: '笔记上的字',
        text:    '"当你把手放在命运的选项上时，注视那些浮现的黑白斑点……它们会预示你的得失。"',
        tip:     '将鼠标悬浮在事件选项上，状态栏对应图标旁会出现黑/白圆点。白点代表增加，黑点代表减少。圆点越大，幅度越剧烈。',
      },
      {
