...
export const DICT = {
  ...
  'map_tutorial_msg': { 
    zh: "欢迎体验由 GroupB2-1 开发的《西浦申研模拟器》MVP 测试版！<br><br>为了适配展会节奏，我们将原本的申请季<b>浓缩为了 4 个月（即 4 个回合）</b>。请合理规划行动点（AP），并留意以下限制：<br><br>📍 <b>探索范围</b><br>校园平面图上建筑对应的<b>蓝色图钉</b>代表可执行行动的建筑，<b>灰色图钉</b>目前仅作校园风貌展示及科普。<br>而由于 Demo 性质和工作量上的考虑，目前<b>【科学楼 SA~SD】、【宿舍】、【图书馆 CB】、【科研 IR】</b>拥有较深的随机事件池；其他蓝色图钉多为默认日常（无数值），防刷设计。<br><br>🎓 <b>主线提醒</b><br>请留意地图上的新建筑解锁提醒（如第 2 个月开启的 <b>IA 楼</b>）。前往那里将触发影响游戏结局的【中介风云】核心事件线。<br><br>祝你在游玩过程中达成好结局，拿到梦校的 Offer！", 
    en: "Welcome to the MVP Demo of 'XJTLU Postgrad Simulator' by GroupB2-1!<br><br>To fit the event's pace, we've <b>compressed the timeline into 4 months (4 rounds)</b>. Please plan your Action Points (AP) wisely and note the following constraints:<br><br>📍 <b>Exploration</b><br>The <b>blue pins</b> on the map indicate actionable buildings, while <b>grey pins</b> are currently for display and info only.<br>Due to the Demo's scope, <b>[SA~SD], [Dorm], [Library CB], and [IR Research]</b> have deeper random event pools; other blue pins mostly use filler scenes with no stat changes to prevent grinding.<br><br>🎓 <b>Main Story Alert</b><br>Watch for new building unlocks (e.g., <b>IA Building</b> in Month 2). Visiting there will trigger the <b>'Agent Turmoil'</b> core storyline, which significantly impacts your final ending.<br><br>Good luck securing your dream Offer!" 
  },
